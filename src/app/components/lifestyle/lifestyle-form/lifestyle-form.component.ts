...
@Component({
  ...
  imports: [MatInputModule, MatSelectModule, ReactiveFormsModule, CommonModule, MatButtonModule],
  templateUrl: './lifestyle-form.component.html',
  styleUrl: './lifestyle-form.component.css',
})
export class LifestyleFormComponent {
  @Input() activeSection!: 'lifestyle' | 'work' | 'exercise' | null;
